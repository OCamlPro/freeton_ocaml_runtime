...
If :code:`freeton_ocaml_runtime` is available in your opam repository, you can just call::

  opam install freeton_ocaml_runtime

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`freeton_ocaml_runtime` in a directory.
