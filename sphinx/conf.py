...
# -*- coding: utf-8 -*-
#
# freeton_ocaml_runtime documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'freeton_ocaml_runtime'
copyright = 'Thomas Blanc <thomas.blanc@ocamlpro.com>'
author = 'Thomas Blanc <thomas.blanc@ocamlpro.com>'
...
latex_documents = [
    (master_doc, 'freeton_ocaml_runtime.tex', 'freeton_ocaml_runtime Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'freeton_ocaml_runtime', 'freeton_ocaml_runtime Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'freeton_ocaml_runtime', 'freeton_ocaml_runtime Documentation',
     author, 'freeton_ocaml_runtime', 'One line description of project.',
     'Miscellaneous'),
]
